...
class DiantarPage extends StatefulWidget {
  ...
  @override
  State<DiantarPage> createState() => _DiantarPageState();
}
...
class _DiantarPageState extends State<DiantarPage> {
  ...
  Future<String?> _getKodeUser() async {
    ...
    try {
      ...
      debugPrint("Error ambil kode_user di DiantarPage: $e");
      return null;
    }
  }
        ...
        if (kodeUserLogin == null) {
         ...
         final Stream<List<Map<String, dynamic>>> _ordersStream =
          Supabase.instance.client
              ...
              .map((data) => data
                  .where((item) => item['status'] == 'diantar')
                  .toList());
        ...
        return Scaffold(
          body: StreamBuilder<List<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              if (orders.isEmpty) {
                return const Center(
                  child: Text("Tidak ada pesanan yg sedang diantar"),
                );
              }
